...
export default function ApplyPage() {
  ...
  const questions = [
    ...
    {
      id: 'willingToInvest',
      question: 'Are you willing to invest financially to reach your goals for your future when all your expectations towards our services are met?',
      type: 'radio',
      icon: CheckCircle,
      options: [
        { value: 'yes', label: 'Yes, I am willing to invest' },
        { value: 'no', label: 'No, I am not willing to invest' },
        { value: 'maybe', label: 'Maybe, depending on the service package' },
      ],
      required: true,
    },
    {
